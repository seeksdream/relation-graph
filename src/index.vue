  ...
  export default {
    ...
    methods: {
      ...
      downloadAsImage(format) {
        ...
        this.nodeViewList.forEach(thisNode => {
          if (_offset_x > 0) thisNode.x += _offset_x
          if (_offset_y > 0) thisNode.y += _offset_y
        })
        console.log('offset:', {_offset_x, _offset_y, _min_x, _min_y, _max_x, _max_y})
        _min_x = 0
        _min_y = 0
        _max_x = 0
        _max_y = 0
        ...
        var relationGraphPosition = {
          left: this.$refs.seeksRelationGraph.offsetLeft,
        ...
        this.$nextTick(() => {
          ...
          const opts = {
            ...
            x: relationGraphPosition.left || 0,
            y: relationGraphPosition.top || 0,
