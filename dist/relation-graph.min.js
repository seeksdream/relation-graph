...
var render = function () {
  ...
  return _c("div", {
    ...
    class: ["rel-node-shape-" + (_vm.nodeProps.nodeShape === undefined ? _vm.graphSetting.defaultNodeShape : _vm.nodeProps.nodeShape), "rel-node-type-" + _vm.nodeProps.type,  _vm.graphSetting.checkedNodeId.has(_vm.nodeProps.id) ? "rel-node-checked" : "", _vm.nodeProps.selected ? "rel-node-selected" : "", _vm.nodeProps.styleClass, _vm.hovering ? "rel-node-hover" : "", _vm.nodeProps.innerHTML ? "rel-diy-node" : ""],
    style: {
...
var SeeksRGLink_render = function () {
  ...
  return _vm.lineProps.isHide !== true && _vm.isAllowShowNode(_vm.lineProps.fromNode) && _vm.isAllowShowNode(_vm.lineProps.toNode) ? _c("g", { ref: "seeksRGLink", attrs: { transform: "translate(0,0)" } }, [_vm._l(_vm.lineProps.relations, function (thisRelation, ri) {
    return [thisRelation.isHide === false ? _c("g", { key: "l-" + thisRelation.id }, [_c("path", {
      ...
      class: [thisRelation.styleClass, _vm.graphSetting.checkedLineId.has(_vm.lineProps.seeks_id)? "c-rg-line-checked" : ""],
      style: {
