(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("vue"), require("screenfull"), require("html2canvas"), require("jspdf"));
	else if(typeof define === 'function' && define.amd)
		define("relation-graph", ["vue", "screenfull", "html2canvas", "jspdf"], factory);
	else if(typeof exports === 'object')
		exports["relation-graph"] = factory(require("vue"), require("screenfull"), require("html2canvas"), require("jspdf"));
	else
		root["relation-graph"] = factory(root["Vue"], root["screenfull"], root["html2canvas"], root["jspdf"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_9__, __WEBPACK_EXTERNAL_MODULE_10__, __WEBPACK_EXTERNAL_MODULE_11__, __WEBPACK_EXTERNAL_MODULE_12__) {
...
// EXTERNAL MODULE: external {"root":"jspdf","commonjs":"jspdf","commonjs2":"jspdf","amd":"jspdf"}
var external___root___jspdf___commonjs___jspdf___commonjs2___jspdf___amd___jspdf__ = __webpack_require__(12);
var external___root___jspdf___commonjs___jspdf___commonjs2___jspdf___amd___jspdf___default = /*#__PURE__*/__webpack_require__.n(external___root___jspdf___commonjs___jspdf___commonjs2___jspdf___amd___jspdf__);
...
/* harmony default export */ var selectortype_script_index_0_src = ({
  ...
  methods: {
    ...
    getBase64(format, encoderOptions) {
      return new Promise(resolve => {
        ...
        this.$nextTick(() => {
          ...
          external___root___html2canvas___commonjs___html2canvas___commonjs2___html2canvas___amd___html2canvas___default()(exportDom, opts).then(canvas => {
            ...
            resolve({ canvas: canvas, base64: dom.toDataURL('image/' + format, encoderOptions) });
          });
        });
      });
    },
    downloadAsPdf(fileName) {
      ...
      console.log(this);
      this.getBase64().then(canvasData => {
        console.log(canvasData);
        let canvas = canvasData.canvas;
        let contentWidth = canvas.width;
        let contentHeight = canvas.height;
        let pageHeight = contentWidth / 592.28 * 841.89; //a4纸的尺寸[595.28,841.89]
        let leftHeight = contentHeight;
        let position = 0;
        let imgWidth = 595.28;
        let imgHeight = 592.28 / contentWidth * contentHeight;
        let pageData = canvasData.base64;
        let PDF = new external___root___jspdf___commonjs___jspdf___commonjs2___jspdf___amd___jspdf___default.a("", "pt", "a4");
    ...
    downloadAsImage(format) {
      if (!format) format = 'png';
      this.getBase64().then(canvasData => {
        const blob = this.dataURLToBlob(canvasData.base64);
