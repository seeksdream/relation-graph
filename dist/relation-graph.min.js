(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("relation-graph", ["vuex"], factory);
	else if(typeof exports === 'object')
		exports["relation-graph"] = factory(require("vuex"));
	else
		root["relation-graph"] = factory(root["Vuex"]);
...
var external___root___Vuex___commonjs___vuex___commonjs2___vuex___amd___vuex__ = __webpack_require__(7);
var external___root___Vuex___commonjs___vuex___commonjs2___vuex___amd___vuex___default = /*#__PURE__*/__webpack_require__.n(external___root___Vuex___commonjs___vuex___commonjs2___vuex___amd___vuex__);

// EXTERNAL MODULE: ./node_modules/_screenfull@4.2.0@screenfull/dist/screenfull.js
var screenfull = __webpack_require__(8);
var screenfull_default = /*#__PURE__*/__webpack_require__.n(screenfull);

// EXTERNAL MODULE: ./node_modules/_html2canvas@1.0.0-rc.5@html2canvas/dist/html2canvas.js
var html2canvas = __webpack_require__(9);
...
var SeeksGraphMath = {
  ...
  analysisNodes4Didirectional: function (willLayoutNodes, thisLevelNodes, thisDeep, analyticResult, levelDirect) {
    ...
    if (newLevelNodes.length > 0) {
      // console.log('thisLevelNodes.length:', thisLevelNodes, thisLevelNodes.length)
      SeeksGraphMath.analysisNodes4Didirectional(willLayoutNodes, newLevelNodes, thisDeep + levelDirect, analyticResult, levelDirect);
    } else {
      willLayoutNodes.forEach(thisNode => {
        if (thisNode.lot.childs_size > 0) {
          thisNode.lot.strengthWithChilds = 0;
...
function SeeksCenterLayouter(layoutSetting, graphSetting) {
  ...
  this.placeNodes = function (allNodes, rootNode) {
    ...
    core4vue_SeeksGraphMath.analysisNodes4Didirectional(this.allNodes, [this.rootNode], 0, analyticResult, 1);
  ...
  this.placeRelativePosition = function (rootNode) {
    ...
    this.allNodes.forEach(thisNode => {
      if (thisNode.lot.subling.level === 1) {
        __level1_r = thisNode.lot.subling.all_size * 60 / Math.PI / 2;
        if (__level1_r < 200) __level1_r = 200;
    ...
    this.allNodes.forEach(thisNode => {
      if (thisNode.lot.subling.level > 1) {
        ...
        const _point = core4vue_SeeksGraphMath.getOvalPoint(rootNode.lot.x, rootNode.lot.y, (thisNode.lot.subling.level - 1) * 400 + __level1_r, __area_start + __buff, thisNode.lot.parent.lot.subling.all_strength);
        thisNode.lot.x = _point.x;
        thisNode.lot.y = _point.y;
      }
    });
...
/* harmony default export */ var SeeksRGStore = (SeeksStoreManager);
// EXTERNAL MODULE: ./node_modules/_velocity-animate@1.5.2@velocity-animate/velocity.js
...
/* harmony default export */ var SeeksRGNode = ({
  ...
  methods: {
    ...
    enter(el, done) {
      console.log('enter');
      velocity_default()(el, { opacity: 1, fontSize: '1.4em' }, { duration: 300 });
      velocity_default()(el, { fontSize: '1em' }, { complete: done });
    },
    leave(el, done) {
      console.log('leave');
      velocity_default()(el, { translateX: '0px', rotateZ: '360deg' }, { duration: 600 });
...
var render = function () {
  ...
  return _c("div", {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: _vm.isAllowShow(_vm.nodeProps),
      expression: "isAllowShow(nodeProps)"
    }],
    ref: "seeksRGNode",
    staticClass: "rel-node-peel",
    style: { left: _vm.nodeProps.x + "px", top: _vm.nodeProps.y + "px" },
    on: {
  ...
  }, [_vm.nodeProps.expanded === false ? _c("i", {
  ...
  }) : _vm._e(), _vm._v(" "), _vm.nodeProps.expanded !== false ? _c("i", {
    staticClass: "el-icon-minus",
    on: {
      click: function ($event) {
        $event.stopPropagation();
        return _vm.closeNode($event);
      }
    }
  }) : _vm._e()])]) : _vm._e(), _vm._v(" "), _c("div", {
    staticClass: "rel-node",
    class: ["rel-node-shape-" + (_vm.nodeProps.nodeShape === undefined ? _vm.graphSetting.defaultNodeShape : _vm.nodeProps.nodeShape), "rel-node-type-" + _vm.nodeProps.type, _vm.nodeProps.id === _vm.graphSetting.checkedNodeId ? "rel-node-checked" : "", _vm.nodeProps.selected ? "rel-node-selected" : "", _vm.nodeProps.styleClass, _vm.hovering ? "rel-node-hover" : ""],
    style: {
  ...
  }, [!(_vm.graphSetting.hideNodeContentByZoom === true && _vm.graphSetting.canvasZoom < 40) ? _vm._t("node", [_c("div", {
    staticClass: "c-node-text",
    style: {
      color: _vm.nodeProps.fontColor || _vm.graphSetting.defaultNodeFontColor
    }
  }, [_c("span", {
    domProps: { innerHTML: _vm._s(_vm.getNodeName()) }
...
var GraphMiniView_render = function () {
  ...
  }), 0), _vm._v(" "), _c("div", { staticClass: "c-mini-view", style: _vm.getPositionData() }, [_c("i", { staticClass: "el-icon-view" })])]);
};
...
var GraphMiniToolBar_render = function () {
  ...
  return _c("div", {
  ...
  }, [_c("i", { staticClass: "el-icon-full-screen" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v(_vm._s(_vm.graphSetting.fullscreen ? "退出" : "全屏"))])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button",
    on: {
      click: function ($event) {
  ...
  }, [_c("i", { staticClass: "el-icon-zoom-in" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("放大")])]), _vm._v(" "), _c("div", {
    staticStyle: {
      float: "left",
      "margin-top": "0px",
      height: "20px",
  ...
  }, [_vm._v(_vm._s(_vm.graphSetting.canvasZoom) + "%")]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button",
    staticStyle: { "margin-top": "0px" },
    on: {
      click: function ($event) {
  ...
  }, [_c("i", { staticClass: "el-icon-zoom-out" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("缩小")])]), _vm._v(" "), _vm.graphSetting.layouts.length > 1 ? _c("div", { staticClass: "c-mb-button" }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("布局")]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-child-panel",
    style: {
      width: _vm.graphSetting.layouts.length * 70 + 6 + "px",
      "margin-left": _vm.graphSetting.layouts.length * -70 - 7 + "px"
    }
    ...
    }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v(_vm._s(thisLayoutSetting.label))])]);
  }), 0)]) : _vm._e(), _vm._v(" "), _vm.graphSetting.allowSwitchLineShape ? _c("div", { staticClass: "c-mb-button" }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("线条")]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-child-panel",
    staticStyle: { width: "256px", "margin-left": "-257px" }
  }, [_c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
  ...
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("直线")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
  ...
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("简洁")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
  ...
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("生动")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
  ...
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("鱼尾")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
  ...
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("折线")])])])]) : _vm._e(), _vm._v(" "), _vm.graphSetting.allowSwitchJunctionPoint ? _c("div", { staticClass: "c-mb-button" }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("连接点")]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-child-panel",
    staticStyle: { width: "206px", "margin-left": "-207px" }
  }, [_c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
    ...
    on: {
      click: function ($event) {
        _vm.graphSetting.junctionPoint = "border";
      }
    }
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("边缘")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
    ...
    on: {
      click: function ($event) {
        _vm.graphSetting.junctionPoint = "ltrb";
      }
    }
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("四点")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
    ...
    on: {
      click: function ($event) {
        _vm.graphSetting.junctionPoint = "tb";
      }
    }
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("上下")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    class: {
    ...
    on: {
      click: function ($event) {
        _vm.graphSetting.junctionPoint = "lr";
      }
    }
  }, [_c("i", { staticClass: "el-icon-s-help" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("左右")])])])]) : _vm._e(), _vm._v(" "), _vm.graphSetting.isNeedShowAutoLayoutButton ? _c("div", {
    staticClass: "c-mb-button",
  ...
  }, [!_vm.graphSetting.autoLayouting ? _c("i", { staticClass: "el-icon-magic-stick" }) : _c("i", { staticClass: "el-icon-loading" }), _vm._v(" "), _c("span", { staticClass: "c-mb-text" }, [_vm._v("自动")])]) : _vm._e(), _vm._v(" "), _c("div", { staticClass: "c-mb-button", on: { click: _vm.refresh } }, [_c("i", { staticClass: "el-icon-refresh" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("刷新")])]), _vm._v(" "), _c("div", { staticClass: "c-mb-button" }, [_c("i", { staticClass: "el-icon-download" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("下载")]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-child-panel",
    style: {
      width: _vm.downloadPanelWidth + "px",
      "margin-left": _vm.downloadPanelWidth * -1 - 1 + "px"
    }
  }, [_c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    staticStyle: { width: "50px" },
  ...
  }, [_c("i", { staticClass: "el-icon-picture-outline" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("PNG")])]), _vm._v(" "), _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    staticStyle: { width: "50px" },
    on: {
      click: function ($event) {
  ...
  }, [_c("i", { staticClass: "el-icon-picture-outline" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("JPG")])]), _vm._v(" "), typeof _vm.$parent.onDownloadExcel === "function" ? _c("div", {
    staticClass: "c-mb-button c-mb-button-c",
    staticStyle: { width: "50px" },
    on: {
      click: function ($event) {
  ...
  }, [_c("i", { staticClass: "el-icon-s-grid" }), _c("span", { staticClass: "c-mb-text" }, [_vm._v("Excel")])]) : _vm._e()])])]);
};
...
var GraphBottomPanel_render = function () {
  ...
  return _c("div", {
    ...
    class: { "c-fixedLayout": _vm.$parent.isNeedFixedTools4Bottom },
    style: {
...
/* harmony default export */ var selectortype_script_index_0_src = ({
  ...
  watch: {
    'graphSetting.fullscreen': function (newV, oldV) {
      if (oldV === true || oldV === false) {
        screenfull_default.a.toggle(this.$refs.seeksRelationGraph);
      }
    }
  },
  created() {
    this.SeeksRGStore = SeeksRGStore.createNewStore(this.options || {}, external___root___Vuex___commonjs___vuex___commonjs2___vuex___amd___vuex___default.a);
  ...
  methods: {
    ...
    setOptions(options, callback) {
      this.SeeksRGStore = SeeksRGStore.createNewStore(options, external___root___Vuex___commonjs___vuex___commonjs2___vuex___amd___vuex___default.a);
      this.graphSetting = this.SeeksRGStore.state.graphSetting;
      this.graphSetting.instanceId = 'SRG' + parseInt(Math.random() * 100000);
      this.init();
      callback(this);
    ...
    loadNodes(_nodes) {
      _nodes.forEach(thisNode => {
        ...
        thisNode = core4vue_SeeksRGUtils.json2Node(thisNode);
        if (__isNew) {
  ...
  return _c("div", {
    ...
    on: {
      ...
      mousewheel: function ($event) {
        ...
        return _vm.mouseListener($event);
      }
    }
  }, [_c("div", {
    ref: "seeksRGCanvas",
    staticClass: "rel-map-canvas",
    style: _vm.getCanvasSizeAndPosition()
...
//# sourceMappingURL=relation-graph.min.js.map