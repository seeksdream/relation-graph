...
function at() {
  ...
  function i() {
    try {
      ...
      var r = Object.getOwnPropertyNames(l).map(function(u) {
        return l[u];
      });
  ...
  return ze = i() ? Object.assign : function(s, l) {
    for (var a, r = n(s), h, u = 1; u < arguments.length; u++) {
...
function Bt() {
  ...
  function l(a, r, h) {
    ...
    h !== void 0 && (f = "" + h), r.key !== void 0 && (f = "" + r.key), r.ref !== void 0 && (g = r.ref);
    for (u in r)
      i.call(r, u) && !s.hasOwnProperty(u) && (d[u] = r[u]);
    if (a && a.defaultProps)
      for (u in r = a.defaultProps, r)
        d[u] === void 0 && (d[u] = r[u]);
    return { $$typeof: e, type: a, key: f, ref: g, props: d, _owner: n.current };
  }
...
function Dt() {
  return tt || (tt = 1, function(t) {
    process.env.NODE_ENV !== "production" && function() {
      ...
      var k = !1;
      function E(c) {
        return !!(typeof c == "string" || typeof c == "function" || c === t.Fragment || c === l || c === z || c === s || c === u || c === d || c === P || k || typeof c == "object" && c !== null && (c.$$typeof === g || c.$$typeof === f || c.$$typeof === a || c.$$typeof === r || c.$$typeof === h || c.$$typeof === w || c.$$typeof === x || c[0] === v));
      }
      function D(c, m, y) {
...
const It = "2.0.24", jt = () => window.innerWidth ? window.innerWidth : document.documentElement.clientWidth ? document.documentElement.clientWidth : screen.width, Tt = () => window.innerHeight ? window.innerHeight : document.documentElement.clientHeight ? document.documentElement.clientHeight : screen.height, Ft = (t) => {
  if (!t)
    return 0;
  let e = 0;
  for (const o of t) {
...
(function(t) {
  ...
  e = function() {
    var u, d, f, g;
    (g = document.createElement("div")).innerHTML = a, a = null, (f = g.getElementsByTagName("svg")[0]) && (f.setAttribute("aria-hidden", "true"), f.style.position = "absolute", f.style.width = 0, f.style.height = 0, f.style.overflow = "hidden", u = f, (d = document.body).firstChild ? (g = u, (f = d.firstChild).parentNode.insertBefore(g, f)) : d.appendChild(u));
...
const ot = (t) => {
  ...
  getRectPoint(t, e, o, n, i, s, l, a) {
    const r = t + i / 2, h = e + s / 2, u = o + l / 2, d = n + a / 2, f = r < u ? 1 : -1, g = h < d ? 1 : -1;
    if (d === h)
      return { x: r + f * i / 2, y: h };
    const x = Math.abs((u - r) / (d - h)), v = i / s;
    let w = 0, z = 0;
    return x < v ? (w = f * s / 2 * x, z = g * s / 2) : (w = f * i / 2, z = g * i / 2 / x), { x: r + w, y: h + z };
  },
  getRectPointBasic(t, e, o, n, i, s, l, a) {
    const r = t + i / 2, h = e + s / 2, u = o + l / 2, d = n + a / 2;
    let f = d === h ? 0 : (u - r) / (d - h);
    f === 0 && (f = (u - r) / (d - h + 1));
    const g = i / a;
    let x = 0, v = 0, w = "1";
    return -1 * g < f && f < g ? (w = "2", h < d ? (x = s / 2 * f, v = s / 2) : (x = -1 * s / 2 * f, v = -1 * s / 2)) : (r < u ? (x = 1 * i / 2, v = 1 * i / 2 / f) : (x = -1 * i / 2, v = -1 * i / 2 / f), w = "3"), { x: r + x, y: h + v, _case: w };
  },
  getRectJoinPoint(t, e, o, n, i, s, l, a) {
    const r = t + i / 2, h = e + s / 2, u = o + l / 2, d = n + a / 2, f = Math.round(
      Math.atan2(d - h, u - r) * 180 / 3.14
    ) + 135;
  ...
  getRectHJoinPoint(t, e, o, n, i, s, l) {
    const a = s / 2;
    return t + i < o ? { x: t + i + 5, y: e + a } : t + i < o + l ? { x: t - 5, y: e + a } : { x: t - 5, y: e + a };
  },
  getRectVJoinPoint(t, e, o, n, i, s, l, a) {
    const r = i / 2;
    return e + s < n ? { y: e + s + 5, x: t + r } : e + s < n + a ? { y: e - 5, x: t + r } : { y: e - 5, x: t + r };
  },
  getBorderPoint(t, e, o, n, i, s, l, a, r) {
    return r === 0 ? this.getCirclePoint(t, e, o, n, i, s, l, a) : this.getRectPoint(t, e, o, n, i, s, l, a);
  },
  getBorderPoint4MultiLine(t, e, o, n, i, s, l, a, r, h, u, d) {
    return r === 0 ? this.getCirclePoint4MultiLine(
      ...
      u,
      d
    ) : this.getRectPoint(t, e, o, n, i, s, l, a);
  },
  getCirclePoint(t, e, o, n, i, s, l, a) {
    const r = o + l / 2, h = n + a / 2, u = t + i / 2, d = e + s / 2, f = r - u;
    if (f === 0)
      return { x: u, y: d - s / 2 * (h < d ? 1 : -1) };
    const x = (h - d) / f, v = Math.sqrt(1 / (1 / (i / 2) ** 2 + x ** 2 / (s / 2) ** 2)) * (r < u ? 1 : -1), w = x * v;
    return { x: u - v, y: d - w };
  },
  getCirclePoint4MultiLine(t, e, o, n, i, s, l, a, r, h, u) {
    r && (u = h - u - 1);
    const d = o + l / 2, f = n + a / 2, g = t + i / 2, x = e + s / 2, v = d - g;
    if (v === 0)
  ...
  getCirclePointBasic(t, e, o, n, i, s, l, a, r) {
    const h = t + i / 2, u = e + s / 2, d = o + l / 2, f = n + a / 2, g = d - h, x = f - u, v = Math.sqrt(g * g + x * x), w = v - r, z = w * g / v * -1, P = w * x / v * -1;
    return { x: d + z, y: f + P };
  },
  getCirclePointPlus(t, e, o, n, i, s, l, a) {
    const r = t + i / 2, h = e + s / 2, u = o + l / 2, d = n + a / 2, f = u - r, g = d - h, x = Math.sqrt(f * f + g * g), v = (x - i / 2) * f / x * -1, w = (x - s / 2) * g / x * -1;
    return { x: u + v, y: d + w };
  },
  ...
  analysisNodes(t, e, o, n) {
    ...
    e.forEach((a) => {
      a.lot || (a.lot = { childs: [] }), a.lot.eached = !0, a.lot.subling = i, a.lot.level = o, t.push(a);
    });
    let l = 0;
    e.forEach((a) => {
      let r = 0;
      if (a.targetNodes) {
        let h = 0;
        a.targetNodes.forEach((u) => {
          u.lot || (u.lot = { childs: [], eached: !1 }), u.lot.eached || (B.isAllowShowNode(u) ? (u.lot.eached = !0, u.lot.parent = a, u.lot.index_of_parent = h++, a.lot.childs.push(u), s.push(u), r++) : a.lot.childs.push(u));
        });
      }
      a.lot.strength = r > 0 ? r : 1, i.all_strength += a.lot.strength, a.lot.strength_plus = i.all_strength, a.lot.index_of_level = l, a.lot.childs_size = r, l++;
  ...
  analysisNodes4Didirectional(t, e, o, n, i) {
    ...
    e.forEach((r) => {
      r.lot || (r.lot = { childs: [] }), r.lot.eached = !0, r.lot.subling = s, r.lot.level = o, t.push(r);
    });
    let a = 0;
    e.forEach((r) => {
      let h = 0;
      if (i === 0) {
        ...
        r.targetNodes.forEach((d) => {
          d.lot || (d.lot = { childs: [], eached: !1 }), d.lot.eached || (B.isAllowShowNode(d) ? (d.lot.eached = !0, d.lot.parent = r, d.lot.index_of_parent = u++, r.lot.childs.push(d), l.push(d), h++) : r.lot.childs.push(d));
        });
      } else if (i === -1) {
        let u = 0;
      ...
      r.lot.strength = h > 0 ? h : 1, s.all_strength += r.lot.strength, r.lot.strength_plus = s.all_strength, r.lot.index_of_level = a, r.lot.childs_size = h, a++;
      ...
      r.lot.childs_size === 0 && (r.lot.strengthWithChilds = 1, B.conductStrengthToParents(r));
  ...
  const i = t - o, s = e - n, l = i ** 2, a = s ** 2, r = l + a;
  return Math.sqrt(r);
}, Yt = ({ link: t, relation: e, relationIndex: o }) => {
  const n = G(X), i = G(oe), s = t.seeks_id === n.options.checkedLineId, l = Ft(e.text) * 10, r = (Gt(
    t.fromNode.x,
    t.fromNode.y,
    t.toNode.x,
    t.toNode.y
  ...
  const n = G(X), i = G(oe), s = t.seeks_id === n.options.checkedLineId, { path: l, textPosition: a } = n.createLinePath(
    t,
    e,
    o
  ), r = n.getTextTransform(
    e,
    a.x,
    a.y,
    a.rotate
  ...
  return /* @__PURE__ */ L("g", { children: [
    ...
    u && /* @__PURE__ */ p("g", { transform: r, children: /* @__PURE__ */ p(
      "text",
      {
        x: "0",
        y: "0",
  ...
  ye(() => {
    var g, x;
    return _("[RGCanvas mounted]"), a(), e.setCanvasDom(i.current), (x = (g = i.current) == null ? void 0 : g.parentElement) == null || x.addEventListener("wheel", r, { passive: !1, capture: !0 }), () => {
      var v, w;
      (w = (v = i.current) == null ? void 0 : v.parentElement) == null || w.removeEventListener("wheel", r);
    };
  }, []);
  const a = () => {
...
class Qt {
    ...
    o.forEach((h) => {
      ...
      if (s === -1) {
        ...
        h.targetFrom.forEach((f) => {
          f.lot || (f.lot = { childs: [], eached: !1 }), f.lot.eached || (B.isAllowShowNode(f) ? (f.lot.eached = !0, f.lot.parent = h, f.lot.index_of_parent = d++, h.lot.childs.push(f), a.push(f), u++) : h.lot.childs.push(f));
        });
      } else {
        let d = 0;
      ...
      h.lot.strength = u > 0 ? u : 1, l.all_strength += h.lot.strength, h.lot.strength_plus = l.all_strength, h.lot.index_of_level = r, h.lot.childs_size = u, r++;
    }), l.all_strength > i.max_strength && (i.max_strength = l.all_strength), a.length > 0 ? this.analysisNodes4Didirectional(
      e,
      a,
      n + s,
      i,
  ...
  placeNodesPosition(e, o, n) {
    if (e.fixed !== !0) {
      const l = this.layoutOptions.centerOffset_x || 0, a = this.layoutOptions.centerOffset_y || 0, r = e.el.offsetWidth || e.width || 60, h = e.el.offsetHeight || e.height || 60;
      e.lot.x = -r / 2 + l, e.lot.y = -h / 2 + a, this.layoutOptions.from === "top" ? e.lot.y -= this.graphOptions.viewSize.height / 2 - h - 100 : this.layoutOptions.from === "bottom" ? e.lot.y += this.graphOptions.viewSize.height / 2 - h - 200 : this.layoutOptions.from === "right" ? e.lot.x += this.graphOptions.viewSize.width / 2 - r - 100 : e.lot.x -= this.graphOptions.viewSize.width / 2 - r - 100, _("graph offset:", l, a), _("create rootNode coordinates:", e.lot.x, e.lot.y), e.x = e.lot.x + 0, e.y = e.lot.y + 0;
    } else
    ...
    e.lot.placed = !0, this.placeRelativePosition(e, n), o.forEach((l) => {
      ...
      if (!B.isAllowShowNode(l))
        return;
      const a = l.offset_x || 0, r = l.offset_y || 0;
      l.x = l.lot.x + a, l.y = l.lot.y + r, l.lot.placed = !0;
    });
  }
  placeRelativePosition(e, o) {
    ...
    if (this.layoutOptions.from === "left" || this.layoutOptions.from === "right") {
      const s = this.layoutOptions.min_per_height || 80, l = this.layoutOptions.max_per_height || 400, a = this.layoutOptions.min_per_width || 430, r = this.layoutOptions.max_per_width || 650;
      let h = Math.round(
        (n - 10) / (o.max_deep + 2)
      );
      h < a && (h = a), h > r && (h = r);
      ...
      const s = this.layoutOptions.min_per_height || 250, l = this.layoutOptions.max_per_height || 400, a = this.layoutOptions.min_per_width || 250, r = this.layoutOptions.max_per_width || 500;
      let h = Math.round(
  ...
  getLevelDistance(e, o, n) {
    ...
    if (this.levelDistanceArr && this.levelDistanceArr.length > 0) {
      let s = 0;
      for (let l = 0; l < i; l++) {
        const a = this.levelDistanceArr[l] || 100;
        s += a;
      }
      return o > 0 ? s : s * -1;
    } else
...
class we {
  ...
  placeRelativePosition(e, o) {
    ...
    this.allNodes.forEach((i) => {
      ...
      if (i.lot.subling && i.lot.subling.level > 1 && i.lot.parent) {
        const s = i.lot.parent.lot.strength_plus - i.lot.parent.lot.strength, a = (i.lot.parent.lot.strength_plus - s) / (i.lot.parent.lot.childs_size + 1) * (i.lot.index_of_parent + 1), r = B.getOvalPoint(
          e.lot.x,
          e.lot.y,
  ...
  addElasticByLine(e, o) {
    ...
    n > 1e3 && (n = 1e3);
    const i = n < 30 ? 0 : (n - 30) * 0.05, s = i, l = i, a = (e.x - o.x) / n, r = (e.y - o.y) / n;
    this.addFtoNode(e, a * s * -1, r * s * -1), this.addFtoNode(o, a * l, r * l);
  }
  addGravityByNode(e, o) {
    ...
    const l = (e.x - o.x) / n, a = (e.y - o.y) / n;
    this.addFtoNode(e, l * s, a * s), this.addFtoNode(o, l * s * -1, a * s * -1);
  }
  getNodeFWeight(e) {
    let o = e.lot.level;
...
class eo extends we {
  ...
  placeNodes(o, n) {
    ...
    B.analysisNodes4Didirectional(
      ...
      if (s.fixed === !0 || !B.isAllowShowNode(s))
        return;
      const l = s.offset_x || 0, a = s.offset_y || 0;
      s.x = s.lot.x + l, s.y = s.lot.y + a, s.lot.placed = !0;
    }), _("Start Auto Layout.....");
  }
  placeRelativePosition(o, n) {
    ...
    const a = Math.round(300 * i);
    this.allNodes.forEach((r) => {
      var h;
      if (r.lot.parent && r.lot.subling && r.lot.subling.level > 1) {
        const u = r.lot.parent.lot.strength_plus - r.lot.parent.lot.strength, f = (r.lot.parent.lot.strength_plus - u) / (r.lot.parent.lot.childs_size + 1) * (r.lot.index_of_parent + 1), g = B.getOvalPoint(
          o.lot.x,
          o.lot.y,
          (r.lot.subling.level - 1) * a + l,
          u + f,
          (h = r.lot.parent.lot.subling) == null ? void 0 : h.all_strength
        );
        r.lot.x = g.x, r.lot.y = g.y;
      }
    });
  }
}
class to extends we {
  ...
  checkMaxDeepAndLength(o, n) {
    ...
    o.forEach((a) => {
      a.lot || (a.lot = { childs: [] }), a.lot.eached = !0, a.lot.subling = i, this.allNodes.push(a);
    });
    let l = 0;
    o.forEach((a) => {
      let r = 0;
      a.targetNodes && (a.targetNodes.forEach((h) => {
        _("child node::", h.type, h.lot.eached), h.lot || (h.lot = { childs: [], eached: !1 }), h.type === "node" && h.targetNodes.length <= 1 ? h.lot.eached || (h.lot.parent = a, h.lot.index_of_p_childs = r, a.lot.childs.push(h), a.lot.eached = !0, s.push(h), r++) : h.lot.notLeafNode = !0;
      }), a.targetNodes.forEach((h) => {
        h.lot.notLeafNode && (h.lot || (h.lot = { childs: [], eached: !1 }), h.lot.eached || (h.lot.parent = a, h.lot.index_of_p_childs = r, a.lot.childs.push(h), a.lot.eached = !0, s.push(h), r++));
      })), a.lot.strength = r > 0 ? r : 1, i.all_strength += a.lot.strength, a.lot.strength_plus = i.all_strength, a.lot.level_index = l, a.lot.childs_size = r, l++;
  ...
  placeNodes(o, n) {
    ...
    this.__origin_nodes = o, this.rootNode = n, o.forEach((a) => {
      a.lot.eached = !1, a.lot.notLeafNode = !1, a.lot.childs = [], a.lot.parent = void 0, a.lot.index_of_p_childs = 0, a.lot.strength = 0;
    }), this.allNodes = o, _("max before:", this.__max_deep, this.__max_length), _("max after:", this.__max_deep, this.__max_length);
    const i = {
      x: 0,
      y: 0
    }, s = this.allNodes.length;
    let l = s * 90 / Math.PI / 2;
    l < 200 && (l = 200), l > 800 && (l = 800), this.allNodes.forEach((a, r) => {
      const h = B.getOvalPoint(
        i.x,
        i.y,
        l,
...
const rt = (t, e) => {
  ...
  const t = G(X), e = G(oe), o = () => {
    ...
    _("change layout:", r), no(r, t.options), o(), e();
  }, i = () => {
    t.startAutoLayout();
  }, s = (r) => {
    t.setDefaultLineShape(r), e();
  }, l = (r) => {
    t.setDefaultJunctionPoint(r), e();
  }, a = 106;
  return /* @__PURE__ */ L(
    "div",
    {
        ...
        t.options.layouts.length > 1 && /* @__PURE__ */ L("div", { className: "c-mb-button", children: [
          ...
          /* @__PURE__ */ p(
            "div",
            {
              ...
              children: t.options.layouts.map((r) => /* @__PURE__ */ L(
                "div",
                {
                  className: ["c-mb-button", "c-mb-button-c", t.options.layoutLabel === r.label ? "c-mb-button-on" : ""].join(" "),
                  style: { width: "70px" },
                  onClick: () => {
                    n(r);
                  },
                  children: [
                    /* @__PURE__ */ p("svg", { className: "rg-icon", "aria-hidden": "true", children: /* @__PURE__ */ p("use", { xlinkHref: "#icon-yuanquanfenxiang" }) }),
                    /* @__PURE__ */ p("span", { className: "c-mb-text", children: r.label })
                  ]
                },
                r.label
              ))
    ...
    if (typeof i == "object") {
      ...
      if (s)
        if (s && !Array.isArray(s) && i)
          ...
          const l = [];
          i.forEach((a) => {
            a && typeof a == "object" ? l.push(JSON.parse(JSON.stringify(a))) : l.push(a);
          }), e[n] = l;
        } else
          e[n] = i;
      else
...
class vo extends go {
  ...
  loadLines(o) {
    o.forEach((n) => {
      ...
      const a = `${s.seeks_id}-${l.seeks_id}`, r = `${l.seeks_id}-${s.seeks_id}`, h = lo(n);
      let u, d = !1;
      this.tmpData.links_map[a] ? u = this.tmpData.links_map[a] : this.tmpData.links_map[r] ? (u = this.tmpData.links_map[r], d = !0) : (i = !0, u = {
        seeks_id: a,
        fromNode: s,
        toNode: l,
        appended: !1,
  ...
  flatNodeData(o, n, i, s) {
    o.forEach((l) => {
      ...
      const a = l.children;
      a && a.length > 0 && this.flatNodeData(a, l, i, s);
    });
  }
  loadGraphJsonData(o) {
    if (!o.lines) {
  ...
  getLineArrow(o, n = !1, i = !1) {
    ...
    if (o) {
      ...
      return this.allLineColors.map((a) => a.id).includes(l) || this.allLineColors.push({ id: l, color: o }), `${this.options.instanceId}-${s}arrow-${l}`;
    } else
    ...
    for (let s = 0; s < this.graphData.nodes.length; s++)
      if (this.graphData.nodes[s].id === o) {
        ...
        l.targetNodes.forEach((a) => {
          const r = a.targetNodes.indexOf(l);
          r !== -1 && a.targetNodes.splice(r, 1);
...
class xo extends yo {
  ...
  showZoomCenter(o, n) {
    if (!this.$dom)
      return;
    const i = this.options.canvasZoom / 100, s = (this.options.canvasZoom + o) / 100, l = this.analysisByZoom(i, n), a = this.analysisByZoom(s, n), r = s / i, h = 0, u = 0, d = s / i, f = 0, g = 0;
    this.zoomCenter_of_newSize.x = r * l.NMViewBuff.x + u * l.NMViewBuff.y + f, this.zoomCenter_of_newSize.y = h * l.NMViewBuff.x + d * l.NMViewBuff.y + g;
    ...
    let w = l.NMCanvasStart.x - l.NMCanvasCenter.x, z = l.NMCanvasStart.y - l.NMCanvasCenter.y, P = r * w + u * z + f, b = h * w + d * z + g;
    return a.NMCanvasStart.x = x + l.NMCanvasCenter.x + P, a.NMCanvasStart.y = x + l.NMCanvasCenter.y + b, w = l.NMCanvasEnd.x - l.NMCanvasCenter.x, z = l.NMCanvasEnd.y - l.NMCanvasCenter.y, P = r * w + u * z + f, b = h * w + d * z + g, a.NMCanvasEnd.x = x + l.NMCanvasCenter.x + P, a.NMCanvasEnd.y = x + l.NMCanvasCenter.y + b, l.NMCanvasOffsetBuff.x = x, l.NMCanvasOffsetBuff.y = v, {
      buff_x: x,
      buff_y: v
    };
  }
  analysisByZoom(o, n) {
    ...
    }, s = jt(), l = Tt(), a = this.$dom.getBoundingClientRect();
    i.NMViewPosition.x = a.left, i.NMViewPosition.y = a.top, a.width + i.NMViewPosition.x > s ? i.NMViewCenter.x = (s - a.left) / 2 : i.NMViewCenter.x = a.width / 2, a.height + i.NMViewPosition.y > l ? i.NMViewCenter.y = (l - a.top) / 2 : i.NMViewCenter.y = a.height / 2;
    const r = this.options.canvasSize.width * o, h = this.options.canvasSize.height * o;
    i.NMCanvasCenter.x = this.options.canvasOffset.x + this.options.canvasSize.width / 2, i.NMCanvasCenter.y = this.options.canvasOffset.y + this.options.canvasSize.height / 2, i.NMCanvasStart.x = i.NMCanvasCenter.x - r / 2, i.NMCanvasStart.y = i.NMCanvasCenter.y - h / 2, i.NMCanvasEnd.x = i.NMCanvasCenter.x + r / 2, i.NMCanvasEnd.y = i.NMCanvasCenter.y + h / 2, i.NMZoomCenter.x = i.NMViewCenter.x, i.NMZoomCenter.y = i.NMViewCenter.y, n && (i.NMZoomCenter.x = n.x - i.NMViewPosition.x, i.NMZoomCenter.y = n.y - i.NMViewPosition.y);
    let u = i.NMViewCenter.x - i.NMCanvasCenter.x, d = i.NMViewCenter.y - i.NMCanvasCenter.y;
    return n && (u = i.NMZoomCenter.x - i.NMCanvasCenter.x, d = i.NMZoomCenter.y - i.NMCanvasCenter.y), i.NMViewBuff.x = u, i.NMViewBuff.y = d, i.NMCanvasSize.width = r, i.NMCanvasSize.height = h, i;
  }
}
class wo extends xo {
  constructor(e, o) {
  ...
  getStuffSize() {
    ...
    this.graphData.nodes.forEach((r) => {
      r.x < e && (e = r.x), r.x > n && (n = r.x + r.el.offsetWidth), r.y < o && (o = r.y), r.y > i && (i = r.y + r.el.offsetHeight);
    });
    const s = 100, l = n - e + s, a = i - o + s;
    return {
      width: l,
      height: a,
      minX: e,
  ...
  animateGoto(e, o, n, i) {
    _("animateGoto:", e, o);
    const s = e - this.options.canvasOffset.x, l = o - this.options.canvasOffset.y, a = n, r = 5, h = Math.round(s / r), u = Math.round(l / r), d = a / r;
  ...
  animateToZoom(e, o, n) {
    const i = e - this.options.canvasZoom, s = o, l = 5, a = Math.round(i / l), r = s / l;
    _("animateToZoom:", i, a), this.animateStepAction(
      0,
      r,
      l,
      () => {
...
class Co extends bo {
  ...
  downloadAsImage(e, o = "png") {
    ...
    let a = 999999, r = 999999, h = 0, u = 0;
    const d = 100;
    this.graphData.nodes.forEach((C) => {
      C.x < a && (a = C.x), C.x > h && (h = C.x + C.el.offsetWidth), C.y < r && (r = C.y), C.y > u && (u = C.y + C.el.offsetHeight);
    });
    const f = a - d, g = r - d;
    this.graphData.nodes.forEach((C) => {
      C.x = C.x - f, C.y = C.y - g;
    ...
    const w = h - a + 200 + d * 2, z = u - r + 100 + d * 2, P = window.devicePixelRatio;
  ...
  createImage(e, o, n, i, s) {
    _("html2canvas:", o, n, i), Ot(e, o).then((l) => {
      const a = document.body.appendChild(l);
      a.style.display = "none";
      const r = this.dataURLToBlob(a.toDataURL(`image/${n}`));
      document.body.removeChild(a);
      const h = document.createElement("a");
      h.style.display = "none";
      try {
        window.navigator.msSaveOrOpenBlob ? window.navigator.msSaveOrOpenBlob(r, `${i}.${n}`) : (h.setAttribute("href", URL.createObjectURL(r)), h.setAttribute("download", `${i}.${n}`), document.body.appendChild(h), h.click(), _("click ok!"), URL.revokeObjectURL(r), _("revokeObjectURL ok!"), document.body.removeChild(h), _("removeChild ok!")), s && s();
      } catch (u) {
...
class Mo extends Co {
  ...
  createLinePath(e, o, n) {
    ...
    n || (n = 0);
    const l = o.lineShape || this.options.defaultLineShape || 1, a = o.lineDirection || this.options.layoutDirection || "h";
    let r = i.x, h = i.y, u = s.x, d = s.y;
    ...
    if (l === 4) {
      ...
      a === "v" ? (E = E - (D * 33 + A), f.x = C + k + 5, f.y = O + D * 40 + A, f.rotate = 90, V = `M ${C} ${O} v${D * 33 + A} h${k + A} v${E}`) : o.reverseText === !0 ? (f.x = C + D * 10 - (D < 0 ? 30 : 0), f.y = O - 5, k = k - D * 120, V = `M ${C} ${O} h${D * 120} v${E} h${k}`) : (f.x = C + D * 50 - (D < 0 ? 30 : 0), f.y = O + E - 5 + A, k = k - (D * 33 + A), E = E + D * A, V = `M ${C} ${O} h${D * 33 + A} v${E} h${k}`);
    } else if (l === 2) {
      ...
      a === "v" ? V = `M${C},${O} c${0},${D * 30} ${k * ne},${D * -10} ${k},${E}` : V = `M${C},${O} c${D * 30},${0} ${D * -10},${E * ne} ${k},${E}`;
    } else if (l === 6) {
      const A = S.y > b.y ? 1 : -1, Y = Math.abs(k) + Math.abs(E);
      f.x = Math.round(S.x - k / Y * 60 - 20), f.y = Math.round(
        S.y - E / Y * 60 - 20 * A
      ), a === "v" ? V = `M${C},${O} c${0},${E / 2} ${k},${E / 2} ${k},${E}` : V = `M${C},${O} c${k / 2},${0} ${k / 2},${E} ${k},${E}`;
    } else if (l === 3) {
      f.x = S.x - D * 63, f.y = S.y + 3;
      const A = 1 / (e.relations.length + 1) * (n + 1) - 0.5 + 0.5;
      a === "v" ? V = `M${C},${O} c${0},${E * A} ${0},${0} ${k},${E}` : V = `M${C},${O} c${D * 30},${0} ${D * -10},${E * A} ${k},${E}`;
    } else if (l === 5) {
      f.x = S.x - D * 63, f.y = S.y + 3;
      const A = 1 / (e.relations.length + 1) * (n + 1) - 0.5 + 0.5;
      a === "v" ? V = `M${C},${O} c${0},${0} ${0},${E * A} ${k},${E}` : V = `M${C},${O} c${0},${0} ${k * A},${0} ${k},${E}`;
    } else {
...
const Eo = (t, e) => {
  ...
  ye(() => {
    const a = t.relationGraphCore || new So(t.options, o);
    s.current = a, l();
  }, []), At(e, () => ({
    getInstance() {
      return s.current;
    ...
    setOptions(a, r) {
      s.current.setOptions(a, r), l();
    },
    setJsonData(a, r, h) {
      arguments.length === 2 && typeof r == "function" && (h = r, r = !0), s.current.setJsonData(
        a,
        r,
        (u) => {
          u.playShowEffect(() => {
    ...
    appendJsonData(a, r, h) {
      arguments.length === 2 && typeof r == "function" && (h = r, r = !0), s.current.appendJsonData(a, r, (u) => {
        l(), h && h(u);
      });
    },
    setLayouter(a) {
      s.current.setLayouter(a), l();
    },
    onGraphResize() {
    ...
    focusNodeById(a) {
      s.current.focusNodeById(a), l();
    },
    getNodeById(a) {
      return s.current.getNodeById(a);
    },
    removeNodeById(a) {
      return s.current.removeNodeById(a);
    },
    getNodes() {
