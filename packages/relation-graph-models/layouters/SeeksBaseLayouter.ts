...
export class SeeksBaseLayouter {
  ...
  snapshotBeforeAnimation() {
    this.allNodes.forEach(thisNode => {
      ...
      thisNode.lot.to_x = RGNodesAnalytic.getNodeXByLotX(this.graphOptions, thisNode);
      thisNode.lot.to_y = RGNodesAnalytic.getNodeYByLotY(this.graphOptions, thisNode);
