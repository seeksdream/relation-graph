...
export declare interface RelationGraph {
    ...
    setOptions(
        options: RGOptions,
        callback?: (graphInstance: RelationGraph) => void
    )
...
export declare type RGRefreshCallback = (graphInstance: RelationGraph) => void
export declare type RGPosition = {
    x: number
    y: number
}
export declare class RelationGraphElement extends VueElement {
    getInstance(): RelationGraph
    setOptions(
        options: RGOptions,
        callback?: (graphInstance: RelationGraph) => void
    )
...
export default RelationGraphElement
